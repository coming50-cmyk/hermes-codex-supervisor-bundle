...
Codex 版：这份文件定义 worker 和 supervisor 之间的状态回报格式。
...
When Hermes reports to the user or answers progress, direction, or detail questions, the reply must be grounded in current truth, not stale memory.
